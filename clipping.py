# Experiment VI: Clipping algorithms
# Write a program to
...
def init():
    # sets background color as 0
    glClearColor(0.0, 0.0, 0.0, 0.0)
    # sets the coordinates to be0 shown on the window
    gluOrtho2D(-500.0, 500.0, -500.0, 500.0)


# function to initialize glut & create window
def glutFunct():
    glutInit(sys.argv)
    glutInitDisplayMode(GLUT_SINGLE | GLUT_RGB)
    glutInitWindowSize(500, 500)
    glutInitWindowPosition(0, 0)
    glutCreateWindow(b"Clipping Algorithms")
    init()
...
################################################################################
# implementation of Cohen-Sutherland line clipping algo
INSIDE = 0
LEFT = 1
RIGHT = 2
DOWN = 4
...
################################################################################
# function for getting the given polygon
def getPolygon():
...
################################################################################
# implementation of Sutherland-Hodgeman algorithm
